...
We will begin by working in short sprints, so we can begin on the foundation for the game design and functionality, each sprint adding in a testable function. 
...
- Deploy the website for the game on Git.
